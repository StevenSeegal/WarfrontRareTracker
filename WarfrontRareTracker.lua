...
local rareDB = {
    ...
    [1527] = {
        ...
        rares = {
            ...
            [157134] = { name = L["ishak_of_the_four_winds"], npcid = 157134, questId = { 57259 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 73418484 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_MOUNT, itemID = 174641, mountID = 1314, isKnown = false } } }, -- Ishak of the Four Winds | Invasion Type: Black Empire
            ...
            [155703] = { name = L["anquri_the_titanic"], npcid = 155703, questId = { 56834 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 32436446 }, bothphases = true, assault = assaultType.none, loot = {  } }, -- Anq'uri the Titanic
            [157472] = { name = L["aphrom_the_guise_of_madness"], npcid = 157472, questId = { 57437 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 50007868 }, bothphases = true, loot = {  } }, -- Aphrom the Guise of Madness !No known assault!
            [154578] = { name = L["aqir_flayer"], npcid = 154578, questId = { 58612 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 40833822 }, bothphases = true, assault = assaultType.none, loot = {  } }, -- Aqir Flayer
            [154576] = { name = L["aqir_titanus"], npcid = 154576, questId = { 58614 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 41924440 }, bothphases = true, assault = assaultType.none, loot = {  } }, -- Aqir Titanus
            [162172] = { name = L["aqir_warcaster"], npcid = 162172, questId = { 58694 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 40284141 }, bothphases = true, assault = assaultType.none, loot = {  } }, -- Aqir Warcaster
            ...
            [155531] = { name = L["infested_wastewander_captain"], npcid = 155531, questId = { 56823 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 23205852 }, bothphases = true, assault = assaultType.none, loot = {  } }, -- Infested Wastewander Captain
            ...
            [162196] = { name = L["obsidian_annihilator"], npcid = 162196, questId = { 58681 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 35061729 }, bothphases = true, assault = assaultType.none, loot = {  } }, -- Obsidian Annihilator
            ...
            [157470] = { name = L["raas_the_anima_devourer"], npcid = 157470, questId = { 57436 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 50578832 }, bothphases = true, loot = {  } }, -- R'aas the Anima Devourer !No known assault!
            ...
            [157476] = { name = L["shugshul_the_flesh_gorger"], npcid = 157476, questId = { 57439 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 55497972 }, bothphases = true, loot = {  } }, -- Shugshul the Flesh Gorger !No known assault!
            ...
            [151878] = { name = L["sun_king_nahkotep"], npcid = 151878, questId = { 58613 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 79016393 }, bothphases = true, assault = assaultType.none, loot = {  } }, -- Sun King Nahkotep
            ...
            [152431] = { name = L["kaneb_ti"], npcid = 152431, questId = { 55629 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 77005200 }, bothphases = true, loot = {  } }, -- Kaneb-ti !No known assault!
            ...
            [158531] = { name = L["corrupted_neferset_guard"], npcid = 158531, questId = { 57665 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 50007900 }, bothphases = true, loot = {  } }, -- Corrupted Neferset Guard !No known assault!
            [158595] = { name = L["thoughtstealer_vos"], npcid = 158595, questId = { 57673 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 65007200 }, bothphases = true, loot = {  } }, -- Thoughtstealer Vos !No known assault!
            [157469] = { name = L["zothrum_the_intellect_pillager"], npcid = 157469, questId = { 57435 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 0 }, bothphases = true, loot = {  } }, -- Zoth'rum the Intellect Pillager !Coords !No known assault!
            [157390] = { name = L["royolok_the_reality_eater"], npcid = 157390, questId = { 57434 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 0 }, bothphases = true, loot = {  } }, -- R'oyolok the Reality Eater !Coords !No known assault!
        },
    },
    [1530] = {
        ...
        rares = {
            ...
            [157290] = { name = L["jade_watcher"], npcid = 157290, questId = { 57350 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 26821109 }, bothphases = true, assault = assaultType.mogu, loot = {  } }, -- Jade Watcher
    ...
    for mapid, contents in pairs(rareDB) do
        if contents.zoneType ~= nil and contents.zoneType == DB_ZONE_TYPE_ASSAULT then
            ...
            if contents.currentAssault then
                ...
                --print("checkAssaults(): assault = " .. ass)
...
local function checkAssault(mapid, npcid)
    if rareDB[mapid] ~= nil and rareDB[mapid].rares[npcid] ~= nil and rareDB[mapid].rares[npcid].assault ~= nil then
        ...
        for  i = 1, #assault, 1 do
            ...
            if assault[i] == rareDB[mapid].currentAssault or assault[i] == assaultType.none then
...
function WarfrontRareTracker:QUEST_ACCEPTED(_, _, id)
    if id == 56540 then
        printg('Vale assaults unlock detected')
        C_Timer.After(1, function()
            checkAssaults()
        end)
    end
